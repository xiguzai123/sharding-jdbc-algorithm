...
public class HalfYearShardingAlgorithmTest {
    ...
    public void testDoPreciseSharding() {
        HalfYearShardingAlgorithm alg = new HalfYearShardingAlgorithm();
    ...
    public void testRangeDoSharding() throws ParseException {
        ...
        Date low = format.parse("2021-06-01");
        Date up = format.parse("2021-07-31");
